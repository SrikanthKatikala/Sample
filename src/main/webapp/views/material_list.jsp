...
<div class="container mx-left pt-1 text-center">
		<a href="/user/home"><button type="button"
            	...
            	<a href="/materials/add"><button type="button" class="btn btn-primary">+Add New Material</button></a>
            </div>
			...
			<tbody>
				<c:forEach var="material" items="${materials}">
					<tr>
						...
						<a href="update?materialId=${material.materialId}">
						<i class="bi bi-pen"></i>
  ...
  <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001m-.644.766a.5.5 0 0 0-.707 0L1.95 11.756l-.764 3.057 3.057-.764L14.44 3.854a.5.5 0 0 0 0-.708z"/>
						...
						&nbsp&nbsp&nbsp&nbsp
						<a href="delete?materialId=${material.materialId}" onclick="return confirmDeletion()">	
  ...
  <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
	...
	<script>
		  confirmDeletion = ()=>{
			  return confirm("Do you want to delete material?");
		  }
		</script>
</body>
</html>